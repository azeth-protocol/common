    ...
    "outputs": [
      {
        "name": "entries",
        "type": "tuple[]",
        "internalType": "struct RegistrySnapshot[]",
        "components": [
          {
            "name": "tokenId",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "uint8",
        "internalType": "enum IAzethOracle.TokenStatus"
      }
    ],
    "stateMutability": "view"
  },
